...
# motif_names <- read.delim("/Users/TedCCLeung/Documents/Projects/Photoperiod/Analysis/PhMotif/data-raw/motif_names.txt")
# usethis::use_data(motif_names, overwrite = TRUE, compress = "xz")
